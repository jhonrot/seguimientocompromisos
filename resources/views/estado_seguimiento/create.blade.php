...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('estado_seguimientos.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_estado_seguimientos" onclick="loader_function()" >/Estado seguimientos</a>/Nuevo estado seguimiento</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nuevo estado seguimiento</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('estado_seguimientos.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
