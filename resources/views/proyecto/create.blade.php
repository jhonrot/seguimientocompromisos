...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('proyectos.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_proyecto" onclick="loader_function()" >/Proyectos</a>/Nuevo proyecto</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nuevo proyecto</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('proyectos.store') }}" method="POST" id="form_submit" name="form_submit" >
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea id="name" class="form-control @error('name') is-invalid @enderror" name="name" autocomplete="name" minlength="4" maxlength="500" rows="4" required onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" >{{ old('name') }}</textarea>
                        </div>
                    </div>
                </div><br> 
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="bp" type="text" class="form-control @error('bp') is-invalid @enderror" name="bp" value="{{ old('bp') }}" required autocomplete="bp" autofocus minlength="5" maxlength="10" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" >
                        </div>
                    </div>
