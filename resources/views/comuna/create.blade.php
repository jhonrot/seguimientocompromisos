...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('comunas.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_comunas" onclick="loader_function()" >/Comunas</a>/Nueva comuna</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nueva comuna</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('comunas.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
