                        ...
                        @foreach($planes as $plan)
                            <tr>
                                ...
                                <td class="text-center" >
                                    ...
                                    @can('tareas.create')
                                        <a class="btn" href="{{ route('tareas.create') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" onclick="loader_function()"> <span style="font-size: 2em;" class="glyphicon glyphicon-edit"></span> <span style="color:white;">....</span>Añadir tarea<span style="color:white;">...................</span></a><br>
                                    @endcan
