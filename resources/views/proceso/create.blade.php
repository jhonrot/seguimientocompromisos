...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('procesos.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_comunas" onclick="loader_function()" >/Procesos</a>/Nuevo proceso</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nueva proceso</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('procesos.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="proceso" class="form-control @error('proceso') is-invalid @enderror" name="proceso" required minlength="4" maxlength="200" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{ old('proceso') }}" >
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea id="descripcion" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" minlength="3" maxlength="1000" rows="4" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" >{{ old('descripcion') }}</textarea>
                        </div>
                    </div>
                </div>
                <br><br>
