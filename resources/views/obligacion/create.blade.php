...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('obligaciones.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_obligaciones" onclick="loader_function()" >/Obligación</a>/Nueva obligación</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nueva obligación</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('obligaciones.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="obligacion" class="form-control @error('obligacion') is-invalid @enderror" name="obligacion" required minlength="4" maxlength="200" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" value="{{ old('obligacion') }}" >
                        </div>
                    </div>
    ...
    <script>
        ...
        $("#objetivo_id").val("{{ old('objetivo_id') }}");
    </script>
