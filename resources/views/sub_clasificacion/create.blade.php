...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('sub_clasificaciones.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_sub_clasificaciones" onclick="loader_function()" >/Referencia transversal</a>/Nueva Referencia transversal</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Nueva Referencia transversal</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('sub_clasificaciones.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
