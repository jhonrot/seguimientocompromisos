...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('actividades.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&data_search2={{$data_search2}}&page={{$page}}" id="lia_page_actividad" onclick="loader_function()" >/Actividades</a>/Actividad {{ $seguimiento->id }}</p>
        </div>
    </div><br>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <form>
                <input type="text" id="url" name="url" class="form-control" value="{{$select_search}};{{$data_search}};{{$data_search2}};{{$page}};{{$act}}" style="display:none;">
