...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('temas.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&data_search2={{$data_search2}}&page={{$page}}" id="lia_page_tema" onclick="loader_function()" >/Compromisos</a>/Nueva actividad</p>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('seguimientos.store') }}" method="POST" id="form_submit" name="form_submit" enctype="multipart/form-data" >
                ...
                <input type="text" id="url" name="url" class="form-control" value="{{$select_search}};{{$data_search}};{{$data_search2}};{{$page}};{{$them}}" style="display:none;">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="tema_id" id="tema_id" class="form-control @error('tema_id') is-invalid @enderror" required readonly >
