...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('actividades.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&data_search2={{$data_search2}}&page={{$page}}" id="lia_page_actividad" onclick="loader_function()" >/Tareas</a>/Nueva tarea</p>
        </div>
    </div><br>
