...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('temas.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&data_search2={{$data_search2}}&page={{$page}}" id="lia_page_tema" onclick="loader_function()" >/Compromisos</a>/Compromiso {{ $tema->id }}</p>
        </div>
    </div><br>
