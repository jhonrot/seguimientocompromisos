...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('periodos.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_periodos" onclick="loader_function()" >/Periodo</a>/Editar periodo {{ $periodo->id }}</p>
        </div>
    </div><br>

    <div class="row">
        <div class="col-sm-12" align="center" >
            <h1><b>Editar periodo {{ $periodo->id }}</b></h1>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('periodos.update',['periodo' => $periodo->id ]) }}" method="POST" id="form_submit" name="form_submit">
                @csrf
                @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="anio" class="form-control @error('anio') is-invalid @enderror" name="anio" required min="2020" max="2050" value="{{ $periodo->anio }}" >
                        </div>
                    </div>
