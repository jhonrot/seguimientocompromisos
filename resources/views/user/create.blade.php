...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('users.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_user" onclick="loader_function()" >/Usuarios</a>/Nuevo usuario</p>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('users.store') }}" method="POST" id="form_submit" name="form_submit" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="num_document" type="text" class="form-control @error('num_document') is-invalid @enderror" name="num_document" value="{{ old('num_document') }}" required autocomplete="num_document" autofocus minlength="3" maxlength="20" onkeypress="return soloNumeros(event)" >
                        </div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus minlength="3" maxlength="45" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" >
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" autofocus minlength="3" maxlength="90" onkeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" >
                        </div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" minlength="7" maxlength="7" autocomplete="telefono" onkeypress="return soloNumeros(event)" >
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="celular" type="text" class="form-control @error('celular') is-invalid @enderror" name="celular" value="{{ old('celular') }}" minlength="10" maxlength="10" autocomplete="celular" onkeypress="return soloNumeros(event)" >
                        </div>
                    </div>
                </div><br>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" minlength="11" maxlength="45" required autocomplete="email">
                        </div>
                    </div>

                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="glyphicon glyphicon-wrench"><b> Roles </b><span class="text-danger hint--top hint--primary" data-hint="Campo obligatorio" title="Campo obligatorio" style="cursor: pointer;">*</span></label>                       
                            <select name="roles[]" id="roles" class="form-control js-example-basic-multiple @error('roles') is-invalid @enderror" required multiple="multiple" >
                                @foreach($roles->all() as $rol)
                                    <option value="{{$rol->id}}" {{ (collect(old('roles'))->contains($rol->id)) ? 'selected':'' }}   >{{$rol->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="glyphicon glyphicon-lock"><b> Contraseña</b><span class="text-danger hint--top hint--primary" data-hint="Campo obligatorio" title="Campo obligatorio" style="cursor: pointer;">*</span></label>
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required minlength="7" maxlength="45" onkeyUp="pass_length()" >
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="glyphicon glyphicon-lock"><b> Confirmar contraseña</b><span class="text-danger hint--top hint--primary" data-hint="Campo obligatorio" title="Campo obligatorio" style="cursor: pointer;">*</span></label>
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required minlength="7" maxlength="45" onkeyUp="conf_pass_length()" >
                ...
                <div class="row">
                    ...
                    <input type="text" id="foto_inicial" name="foto_inicial" value="" style="display:none;" >
                    ...
                    <div class="col-sm-12" style="margin-top: 25px;display:none;" id="div_registro_fotografico" >
                        ...
                        <div class="row" align="center">
                            <div class="col-sm-6">
                                ...
                                <img style="width:100%;border: 1px solid gray;" id="img_foto" title="Error" src="https://cdn2.iconfinder.com/data/icons/documents-and-files-v-2/100/doc-03-512.png">
    ...
    <script>
        ...
        $("#type_document").val("{{ old('type_document') }}");
        $("#state").val("{{ old('state') }}");
        $("#state_logic").val("{{ old('state_logic') }}");
        $("#equipo_trabajo_id").val("{{ old('equipo_trabajo_id') }}");
