...
@section('content')
    <div class="row">
        <div class="col-sm-12" >
            <p><a href="{{ route('roles.index') }}?select_search={{$select_search}}&data_search={{$data_search}}&page={{$page}}" id="lia_page_role" onclick="loader_function()" >/Roles</a>/Nuevo rol</p>
        </div>
    </div><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ route('roles.store') }}" method="POST" id="form_submit" name="form_submit">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus minlength="4" maxlength="255" >
                        </div>
                    </div>
                </div><br>
